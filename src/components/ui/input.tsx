  ...
  return (
    <textarea
      ...
      className={cn(
        ...
        'flex w-full min-h-[40px] resize-none overflow-hidden rounded-md border border-gray-300 bg-white px-3 py-2 text-sm transition-[height] duration-150 ease-in-out',
