			...
			<button
				...
				className={cn(
					...
					// Variants mapped to @theme inline tokens
					{
						...
						'bg-primary-500 hover:bg-primary-600 focus-visible:ring-primary-500 text-white':
							variant === 'primary',

						// SECONDARY -> hotpink (#fe3557)
						'bg-secondary-500 hover:bg-secondary-600 focus-visible:ring-secondary-500 text-white':
							variant === 'secondary',

						// TERTIARY -> sage (#636e5b)
						'bg-tertiary-500 hover:bg-tertiary-600 focus-visible:ring-tertiary-500 text-white':
							variant === 'tertiary',

						// DANGER -> same hotpink scale (separate token for semantics)
						'bg-danger-500 hover:bg-danger-600 focus-visible:ring-danger-500 text-white':
							variant === 'danger',
